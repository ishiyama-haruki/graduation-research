...
train_logname = '/workspace/nn/results/ntk_3layler/{}/{}/train_log.csv'.format(dataset, n_epochs)
test_logname = '/workspace/nn/results/ntk_3layler/{}/{}/test_log.csv'.format(dataset, n_epochs)
...
plot_from_csv.plot(dataset, n_epochs, 'ntk_3layler')
