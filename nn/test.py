...
for i, mfld_param in enumerate(mfld_params):
    plt.scatter(mfld_param['x'], mfld_param['y'], color=cm.hsv(i/500), s=1)

plt.savefig('/workspace/nn/results/mfld_test.png')
...
for i, ntk_param in enumerate(ntk_params):
    plt.scatter(ntk_param['x'], ntk_param['y'], color=cm.hsv(i/500), s=1)

plt.savefig('/workspace/nn/results/ntk_test.png')